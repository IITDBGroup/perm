...
####################
echo -start server
${INSTALLBINDIR}/postgres -D ${DATADIR} & ${INSTALLBINDIR}/psql -U postgres -c 'CREATE LANGUAGE plpgsql' template1
${INSTALLBINDIR}/postgres -D ${DATADIR} & ${INSTALLBINDIR}/psql -U postgres -c '\i /home/perm/src/contrib/xml2/pgxml.sql' template1
####################
