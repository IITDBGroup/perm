...
extern bool prov_use_set_optimization;
extern bool prov_use_wl_union_semantics;
extern bool prov_use_sublink_optimization_left_join;
extern bool prov_use_sublink_move_to_target;
