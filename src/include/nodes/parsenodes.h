...
typedef struct Query
{
	...
	Node 		*provInfo;		/* node to store information needed / generated by the provenance rewriter */

	Node		*aggprojectClause; /* AGGPROJECT clause */
} Query;

/*****************************************************************************
 * Store information about an aggproject clause.
 *****************************************************************************/

typedef struct AggProjectClause
{
	NodeTag		type;
	List		*projAttrs;
	List 		*isProvRowAttrs;
...
typedef struct RangeTblEntry
{
	...
	bool		isProvBase;		/* true, if this rte should be handled by the provenance rewriter as a base relation */
	List		*provAttrs;		/* a list of attributes that are handled by the provenance rewriter as provenance attributes */
	List 		*annotations;
...
typedef struct SelectStmt
{
	...
	Node 		*provenanceClause;	/* provenance rewritting specified? */
} SelectStmt;
