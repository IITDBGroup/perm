...
typedef struct RangeVar
{
	...
	bool		isProvBase;		/* should this from item be handled like a baserelation by provenance rewriter */
	List		*provAttrs;		/* a list of result attributes of the from item that should be handled as provenance attrs by the provenance rewriter */
	List		*annotations;
} RangeVar;
