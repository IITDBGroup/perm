...
typedef enum NodeTag
{
	...
	/*
	 * TAGS FOR PROVENANCE HELPER NODES
	 */
	T_SublinkInfo = 1000,		/* information about a sublink provrewrite/prov_sublink_util.h */
	T_CorrVarInfo,				/* information about a correlated variable (sublevelsup) in a sublink */
	T_ProvInfo,					/* information about a query node for provenance rewrite */
	T_SelectionInfo,
	T_EquivalenceList,
	T_PushdownInfo,
	T_InequalityGraph,
	T_InequalityGraphNode,
	T_QueryPushdownInfo,
	T_SelScope,
	T_CopyMap,
	T_CopyMapRelEntry,
...
extern void _outNode(StringInfo str, void *obj);
extern void _outDatum(StringInfo str, Datum value, int typlen, bool typbyval);
