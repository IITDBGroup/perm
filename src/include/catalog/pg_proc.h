...
DATA(insert OID = 3775 (  query_sql_to_xml	PGNSP PGUID 12 1  0 f f t f i 1 142 "25" _null_ _null_ _null_ query_sql_to_xml - _null_ _null_ ));
DESCR("Convert an SQL statement given as text into an xml representation.");
DATA(insert OID = 3776 (  bitor_with_null	PGNSP PGUID 12 1  0 f f f f i 2 1562 "1562 1562" _null_ _null_ _null_ bitor_with_null - _null_ _null_ ));
DESCR("Bit wise OR of two varbit parameters. If exactly one of the parameters is NULL returns the other one.");
DATA(insert OID = 3777 (  bitoragg			PGNSP PGUID 12 1 0 t f f f i 1 1562 "1562" _null_ _null_ _null_ aggregate_dummy - _null_ _null_ ));
DESCR("Aggregate version of bitwise OR for bitsets VARBIT.");
DATA(insert OID = 3778 (  reconstructTransToSQL		PGNSP PGUID 12 1 0 t f f f i 2 25 "1562 23" _null_ _null_ _null_ reconstructTransToSQL - _null_ _null_ ));
DESCR("reconstruct a bitset transformation provenance representation into SQL text.");
DATA(insert OID = 3779 ( query_sql_to_simple_xml PGNSP PGUID 12 1  0 f f t f i 1 142 "25" _null_ _null_ _null_ query_sql_to_simple_xml - _null_ _null_ ));
...
DATA(insert OID = 3794 (  hwhy PGNSP PGUID 12 1 0 f f t f i 1 1028 "3786" _null_ _null_ _null_ hwhy - _null_ _null_ ));
DESCR("Interprets an how-CS value as a why-CS value");

/*
 * The row above maps the SQL function name to the C-function name and tells postgres what are the input and output parameters of your function.
