					...
					bool targetlist)
{
	...
	else
	{
		...
		//TODO add extra entry for alias.* to inform the provenance rewriter that there was a .* expression
		if (targetlist)
...
ExpandAllTables(ParseState *pstate)
{
	...
	//TODO add extra entry to mark a * expression for the provenance rewriter
					  ...
					  bool targetlist)
{
	...
	//TODO whats with something like prov_table_arraycolumn.*???
