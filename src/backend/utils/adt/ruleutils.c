...
StringInfo
parseBack(Query *query, bool pretty)
{
	StringInfo buf;
	deparse_context *context;
...
/*
 * parse back a query and garanty that attribute and subquery naming is consistent. E.g. unnamed attributes are assiged unqiue
 * names. This garanties that the parsed back query can be executed again.
 */

StringInfo
parseBackSafe (Query *query)
{
